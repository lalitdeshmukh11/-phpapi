...
define('USER_DEFAULT_AVATAR', 'backend_assets/images/avatars/1.png'); //user placeholder image
//uploads path
define('ADMIN_AVATAR_PATH', 'uploads/admin/'); //user avatar
define('ADMIN_DEFAULT_AVATAR', 'backend_assets/images/avatars/1.png'); //user placeholder image

//Title, Site name, Copyright etc
define('SITE_NAME','OTC Perfex '); //your project name
define('COPYRIGHT',' &copy; ' . date('Y'). ', OTC. All rights reserved.');
...
define('APP_ADMIN_ASSETS_IMG', 'backend_assets/images/logo/');
define('BUCKETNAME', 'cg-robinsons');
define('S3JOBS_URL', 'https://cg-robinsons.s3.us-east-2.amazonaws.com/jobrun/');
define('S3JOBS_ATTACHMENT_URL', 'https://cg-robinsons.s3.us-east-2.amazonaws.com/attachment/');
